...
function mining_process($db_object, $min_support, $min_confidence, $start_date, $end_date, $id_process)
{
    ...
    if ($min_support > 0 && $jumlah_transaksi > 0) {
        $min_support_relative = ($min_support / $jumlah_transaksi) * 100;
    } else {
        $min_support_relative = 0;
    }
    $x = 0;
...
function get_variasi_itemset4($array_itemset4, $item1, $item2, $item3, $item4, $item5, $item6)
{
    ...
    if (!in_array(strtoupper($item5), array_map('strtoupper', $return1))) {
        $return1[] = $item5;
    }
    ...
    if (!in_array(strtoupper($item6), array_map('strtoupper', $return2))) {
        $return2[] = $item6;
    }
    ...
    if (!in_array(strtoupper($item6), array_map('strtoupper', $return3))) {
        $return3[] = $item6;
    }
    ...
    if (!in_array(strtoupper($item6), array_map('strtoupper', $return4))) {
        $return4[] = $item6;
    }


    $return5 = array();
    if (!in_array(strtoupper($item1), array_map('strtoupper', $return5))) {
        $return5[] = $item1;
    }
    ...
    if (!in_array(strtoupper($item6), array_map('strtoupper', $return5))) {
        $return5[] = $item6;
    }
    ...
    if (!in_array(strtoupper($item3), array_map('strtoupper', $return6))) {
        $return6[] = $item3;
    }
    if (!in_array(strtoupper($item4), array_map('strtoupper', $return6))) {
        $return6[] = $item4;
    }
    if (!in_array(strtoupper($item5), array_map('strtoupper', $return6))) {
        $return6[] = $item5;
    }
